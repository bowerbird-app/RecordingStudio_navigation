  ...
  class Engine < ::Rails::Engine
    ...
    class << self
      ...
      def extensions_for(kind, names)
        hooks = RecordingStudioNavigation.configuration.hooks
      ...
      def apply_extensions(target, extensions)
        ...
        applied = target.instance_variable_get(:@recording_studio_navigation_applied_extensions) || identity_hash
        ...
        target.instance_variable_set(:@recording_studio_navigation_applied_extensions, applied)
      end
    ...
    initializer "recording_studio_navigation.apply_model_extensions" do
      config.to_prepare do
        ...
        ActiveRecord::Base.descendants.each do |model|
          ...
          RecordingStudioNavigation::Engine.apply_model_extensions(model)
        end
      end
    end
    ...
    initializer "recording_studio_navigation.apply_controller_extensions" do
      config.to_prepare do
        ...
        ActionController::Base.descendants.each do |controller|
          RecordingStudioNavigation::Engine.apply_controller_extensions(controller)
        end
      end
    end
  end
