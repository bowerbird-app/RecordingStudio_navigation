...
1. Review config/initializers/recording_studio_navigation.rb and set any required options.
2. If you use environment-specific settings, create config/recording_studio_navigation.yml.
3. Install the engine migrations with `bin/rails generate recording_studio_navigation:migrations`.
