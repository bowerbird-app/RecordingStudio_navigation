...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudioNavigation::Engine.root}/"

    @engine_views = Dir.glob(RecordingStudioNavigation::Engine.root.join("app/views/recording_studio_navigation/**/*.erb").to_s)
      .sort
